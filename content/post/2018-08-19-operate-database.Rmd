...
if (length(dir("../../R/data/")) != 0){
    # remove database files
    file.remove(dir("../../R/data/"))
}
```
...
```{r, error=TRUE}
set.seed(123)
con = dbConnect(SQLite(), "../../R/data/products.sqlite")
...
file.remove("../../R/data/products.sqlite")
...
```{r}
con = create_bank("../../R/data/bank.sqlite")
...
```{r, include=FALSE}
if(file.exists("../../R/data/diamonds.sqlite")){
    file.remove("../../R/data/diamonds.sqlite")
}
```


```{r, error=TRUE}
write.csv(diamonds, "../../R/data/diamonds.csv", quote = FALSE, row.names = FALSE)

chunk_rw("../../R/data/diamonds.csv", "../../R/data/diamonds.sqlite", "diamonds")
```
