...
学习自TCGAWorkflow包英文手册：<https://www.bioconductor.org/packages/release/workflows/vignettes/TCGAWorkflow/inst/doc/TCGAWorkflow.html>
...
该工作流基于文章 [TCGA Workflow: Analyze cancer genomics and epigenomics data using Bioconductor packages](https://f1000research.com/articles/5-1542/v2) [@10.12688/f1000research.8923.2].
...
BiocInstaller::biocLite("TCGAWorkflow", dependencies = TRUE)
```
