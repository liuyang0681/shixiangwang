...
# download data following <https://github.com/sejdemyr/ecls>
# run following code
# <w_shixiang@163.com>


# Begin by changing your working directory as necessary here
setwd("E:/Github/shixiangwang/R/dataset/ecls-master")
...
dta <- dta %>%
    filter(l5cathol == 1 | l5public == 1) %>%
    mutate(catholic = if_else(l5cathol == 1, 1, 0))
